...
CRON_JOB="0 0 * * * cd $(dirname $(realpath $0)) && .venv/bin/ape run check_liquidatable_positions --network base:mainnet:alchemy >> ./logs/check_liquidatable_positions.log 2>&1"
